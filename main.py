...
class MagicMethods:
    ...
    def __add__(self, other):
        """
        Магический метод __add__ определяет поведение объекта при попытке прибавления к нему другого объекта
        Например: НашМетод + 2
    ...
    def __radd__(self, other):
        """
        Магический метод __radd__ определяет поведение объекта при попытке его прибавления к другому объекту
        Например: 2 + НашМетод
    ...
    def __iadd__(self, other):
        """
        Магический метод __radd__ определяет поведение объекта при попытке "+="
        Экземпляр = НашМетод
        Например: Экземпляр += 2
    ...
    def __sub__(self, other):
        ...
        По аналогии с __add__, только "-", также есть методы __rsub__ и __isub__
        """

    def __mul__(self):
        """
        Магический метод __mul__
        По аналогии с __add__, только "*", также есть методы __rmul__ и __imul__
        """

    def __truediv__(self):
        """
        Магический метод __truediv__
        По аналогии с __add__, только "/", также есть методы __rtruediv__ и __itruediv__

        """

    def __floordiv__(self):
        """
        Магический метод __floordiv__
        По аналогии с __add__, только "//", также есть методы __rfloordiv__ и __ifloordiv__
        """
